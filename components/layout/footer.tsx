...
const Footer = () => {
    return (
        <footer className="bg-black pt-20">
            ...
            <div className="relative w-full overflow-hidden flex flex-col items-center justify-end h-[30vh] md:h-[50vh]">
                <div
                ...
                <h2 className="relative z-20 text-[20vw] font-black leading-none tracking-tighter text-white select-none translate-y-[15%]">
                    MODFIRST
                </h2>
            </div>
